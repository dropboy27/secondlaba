...
def tar_archive(entered_path, archive_name=""):
    """
    Создаёт TAR архив из каталога
    ...
    shutil.make_archive(archive_name, 'tar', path.parent, path.name)
    logger.success(f"tar {archive_name}")
